DELIMITER //
 ...
 CREATE PROCEDURE setPartierData(IN idProfile INT, IN picture VARCHAR(100), IN `name`VARCHAR(20), IN surnames VARCHAR(45), IN birthdate DATE, IN gender BOOL, IN music VARCHAR(20), IN civil_state VARCHAR(20), IN city VARCHAR(20), IN drink VARCHAR(20), IN about VARCHAR(200), IN facebook VARCHAR(100), IN twitter VARCHAR(100), IN instagram VARCHAR(100))
    BEGIN
		UPDATE Partier p
